...
template <typename T>
ember::fault::seu_t<T>::seu_t(const ember::sim::Tick time, ember::ISaboteur* location)
...
template <typename T>
ember::fault::sa0_t<T>::sa0_t(const ember::sim::Tick time, ember::ISaboteur* location)
...
template <typename T>
ember::fault::sa1_t<T>::sa1_t(const ember::sim::Tick time, ember::ISaboteur* location)
