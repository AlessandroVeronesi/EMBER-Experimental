...
// CTOR
template <typename T>
ember::Port<T>::Port(const char* _portId) : ember::IPort<T>::IPort(),
                                            name(_portId) {
    selfBinded = false;
    isBinded = false;
...
template <typename T>
ember::Port<T>::Port(const std::string _portId) : ember::IPort<T>::IPort(),
                                                  name(_portId) {
    selfBinded = false;
    isBinded = false;
...
ember::Port<T>::Port(const char* _portId, Args... _args) : ember::IPort<T>::IPort(),
                                                           name(_portId) {
    selfBinded = false;
    isBinded = false;
